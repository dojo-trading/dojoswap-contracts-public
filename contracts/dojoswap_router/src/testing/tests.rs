...
use dojoswap::pair::ExecuteMsg as PairExecuteMsg;
use dojoswap::router::{
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        dojoswap_factory: "dojoswapfactory".to_string(),
    };
    ...
    assert_eq!("dojoswapfactory", config.dojoswap_factory.as_str());
}
        ...
        vec![
            SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                msg: to_binary(&ExecuteMsg::ExecuteSwapOperation {
                    operation: SwapOperation::DojoSwap {
                        offer_asset_info: AssetInfo::NativeToken {
                            denom: "ukrw".to_string(),
                        },
                        ask_asset_info: AssetInfo::Token {
...
fn query_reverse_routes_with_from_native() {
    ...
    let msg = QueryMsg::ReverseSimulateSwapOperations {
        ...
        operations: vec![SwapOperation::DojoSwap {
            offer_asset_info: AssetInfo::NativeToken {
                denom: "ukrw".to_string(),
            },
            ask_asset_info: AssetInfo::Token {
