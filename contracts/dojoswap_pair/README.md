...
This is mainly used from dojoswap factory contract to create new dojoswap pair. It initializes all swap created parameters which can be updated later with owner key.
